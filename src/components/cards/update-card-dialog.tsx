...
type UpdateCardDialogProps = Pick<UseUpdateCardDialogReturnType, "form" | "onSubmit" | "open" | "setOpen">;

export function UpdateCardDialog({ form, onSubmit, open, setOpen }: UpdateCardDialogProps) {
  return (
